...
export function TileLayout({ chatOpen, voicePanelWidth = 0 }: TileLayoutProps) {
  const {
    state: agentState,
  ...
  return (
    <div
      className="pointer-events-none fixed top-8 bottom-32 left-0 z-50 md:top-12 md:bottom-40"
      style={{ right: voicePanelWidth }}
    >
